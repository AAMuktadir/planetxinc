      ...
      <div className="bg-whiteBG text-background">
        ...
        <section className="sm:flex justify-center py-0 sm:py-8">
          <Link
            ...
            className="sm:w-1/2 flex flex-col items-center hover:scale-105 duration-500"
          >
            <Image
          ...
          <Link
            ...
            className="sm:w-1/2 flex flex-col items-center sm:translate-y-1/2 hover:scale-105 duration-500"
          >
            <Image
